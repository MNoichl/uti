...
class MyAgent(Agent):
    ...
    def step(self):
        ...
        # TODO: Multiplayer, we need to adapt this so that agents choose n-1 other agents to play with
        ...
        if len(my_neighbors_ids) > 0: # here we need to check for n-1 neighbors
            ...
            pass
        else: # this should be solved differently for multiplayers, since otherwise there would be a lot of random updates
    ...
    def reason(self, player, played_game):
        ...
        Args:
            ...
            played_game (game): A game implemented according to our game-syntax.
        Returns:
            list: A strategy to be used in nashpy.
        """
        prediction = self.my_learner.return_prediction() # (possibly a) TODO: Function defined in learners.py
        ...
        if player.team_reasoner == True:
            ...
            tr_strategies = played_game.return_TR_strategy(prediction)  # TODO: Function defined in game_strtucture.py has to be adapted to game_structure_multiplayers
            ...
            return played_game.return_non_trs_choice(mode="random") # TODO: Function defined in game_strtucture.py has to be adapted to game_structure_multiplayers
...
class team_reasoning_model(Model):
    ...
    Attributes:
        ...
        game (nashpy): a nashpy-game which the agents play. (This might be later updated with the
        ...
        proportion_team_reasoners (float or int): The share of team reasoners. Between 0 and 1. The actual share in the simulation, will be rounded, depending on the number of agents in the simulation.
        ...
        utility_calculation (str): How utilities for the replicator dynamic will be calculated. Either "empirical_average", using
            ...
            The latter approach is faithful to Amadae and Lempert, 2015, and le.ads (qualitatively) to a smoother dynamic
    """
    ...
    def __init__(
        ...
        n_agents,
        init_network, # TODO: check out: What is this? How does this work?
        games,
        ...
        for this_game in self.game_mixture.games_list:
            this_game.tr_choice = this_game.return_team_reasoners_choice() # TODO: adapt
            this_game.non_tr_choice = this_game.return_non_trs_choice() # TODO: adapt
        ...
        self.init_network = init_network # TODO: check how this works
        ...
        agent_reporters = { # TODO: check out how lambda function works
